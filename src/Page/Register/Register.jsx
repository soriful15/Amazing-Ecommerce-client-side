...
<Helmet>
        <title>Amazing Ecommerce | Register  Page</title>
      </Helmet>
                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body w-full">
                            ...
                            <div className="form-control">
                                ...
                                <input {...register("number", { required: true })} type="text" name="number" placeholder="+8801XXXXXXXXX" className="input input-bordered" />
