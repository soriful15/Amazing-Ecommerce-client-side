...
const Footer = () => {
    return (
        <>
                ...
                <footer className="footer p-10  bg-orange-100 text-black   mt-10 w-full">
                    <div>
                        <img src={logo} className='rounded-full w-24' alt="" />
                        <p> <span className='lg:text-2xl text-violet-600'>Amazing Ecommerce</span><br /> ShoniAkhra, Dhaka-1205 Bangladesh</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <a className="link link-hover">shopping club</a>
                        <a className="link link-hover">Press kit</a>
                    </div>
                    <div>
                        <span className="footer-title "> Contact</span>
                        <a className="link link-hover">Email: amazingEcommerce@gmail.com</a>
                ...
                <footer className="footer footer-center p-4 bg-black text-white">
                    <div>
                        <p>Copyright © 2023 - All right reserved by Amazing Ecommerce</p>
                    </div>
                </footer>
